-- Active: 1717362514211@@dpg-cpcfta674orc739uvm60-a.ohio-postgres.render.com@5432@db_dojo
CREATE TABLE Perfil (
...
SELECT 
    CASE 
        WHEN EXISTS (
            SELECT 1 
            FROM usuarios 
            WHERE nombre_usuario = 'Ealas' AND contrasenia = '123'
        ) THEN 1
        ELSE 0
    END AS validado,
    COALESCE((SELECT id 
              FROM usuarios 
              WHERE nombre_usuario = 'Ealas' AND contrasenia = '123'), 0) AS idUsuarios;
