...
import { postEvento, getEvento, dltEvento, updEvento, getEventByDate, getEventoID, getRecentEvents } from "../controllers/EventosController.js";

Evento.use(express.json());

Evento.post('', upload.single('foto'), postEvento);
Evento.get('/recientes', getRecentEvents); 
